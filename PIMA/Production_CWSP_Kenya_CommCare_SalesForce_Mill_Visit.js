  ...
  upsertIf(
    ...
    fields(
      field("Submission_ID__c", function(state){
        return dataValue("id")(state) + "cwspke_child_labour";
      }),
      relationship("Observation__r", "Submission_ID__c", dataValue("id")),
      field("RecordTypeId", "01224000000oSG9AAM"),
      relationship("Observation_Criterion__r", "Unique_Name__c", "cwspke_child_labour"),
...
each(
  ...
  upsertIf(
    ...
    fields(
      field("Submission_ID__c", function(state){
        return dataValue("id")(state) + "cwspke_forced_labour";
      }),
      relationship("Observation__r", "Submission_ID__c", dataValue("id")),
      field("RecordTypeId", "01224000000oSG9AAM"),
      relationship("Observation_Criterion__r", "Unique_Name__c", "cwspke_forced_labour"),
...
each(
  ...
  upsertIf(
    ...
    fields(
      field("Submission_ID__c", function(state){
        return dataValue("id")(state) + "cwspke_minimum_wage";
      }),
      relationship("Observation__r", "Submission_ID__c", dataValue("id")),
      field("RecordTypeId", "01224000000oSG9AAM"),
      relationship("Observation_Criterion__r", "Unique_Name__c", "cwspke_minimum_wage"),
...
each(
  ...
  upsertIf(
    ...
    fields(
      field("Submission_ID__c", function(state){
        return dataValue("id")(state) + "cwspke_restricted_pesticides";
      }),
      relationship("Observation__r", "Submission_ID__c", dataValue("id")),
      field("RecordTypeId", "01224000000oSG9AAM"),
      relationship("Observation_Criterion__r", "Unique_Name__c", "cwspke_restricted_pesticides"),
...
each(
  ...
  upsertIf(
    ...
    fields(
      field("Submission_ID__c", function(state){
        return dataValue("id")(state) + "cwspke_accident_prevention";
      }),
      relationship("Observation__r", "Submission_ID__c", dataValue("id")),
      field("RecordTypeId", "01224000000oSG9AAM"),
      relationship("Observation_Criterion__r", "Unique_Name__c", "cwspke_accident_prevention"),
...
each(
  ...
  upsertIf(
    ...
    fields(
      field("Submission_ID__c", function(state){
        return dataValue("id")(state) + "cwspke_safe_storage";
      }),
      relationship("Observation__r", "Submission_ID__c", dataValue("id")),
      field("RecordTypeId", "01224000000oSG9AAM"),
      relationship("Observation_Criterion__r", "Unique_Name__c", "cwspke_safe_storage"),
...
each(
  ...
  upsertIf(
    ...
    fields(
      field("Submission_ID__c", function(state){
        return dataValue("id")(state) + "cwspke_water_contamination";
      }),
      relationship("Observation__r", "Submission_ID__c", dataValue("id")),
      field("RecordTypeId", "01224000000oSG9AAM"),
      relationship("Observation_Criterion__r", "Unique_Name__c", "cwspke_water_contamination"),
...
each(
  ...
  upsertIf(
    ...
    fields(
      field("Submission_ID__c", function(state){
        return dataValue("id")(state) + "cwspke_water_consumption";
      }),
      relationship("Observation__r", "Submission_ID__c", dataValue("id")),
      field("RecordTypeId", "01224000000oSG9AAM"),
      relationship("Observation_Criterion__r", "Unique_Name__c", "cwspke_water_consumption"),
...
each(
  ...
  upsertIf(
    ...
    fields(
      field("Submission_ID__c", function(state){
        return dataValue("id")(state) + "cwspke_ecosystem_protection";
      }),
      relationship("Observation__r", "Submission_ID__c", dataValue("id")),
      field("RecordTypeId", "01224000000oSG9AAM"),
      relationship("Observation_Criterion__r", "Unique_Name__c", "cwspke_ecosystem_protection"),
...
each(
  ...
  upsertIf(
    ...
    fields(
      field("Submission_ID__c", function(state){
        return dataValue("id")(state) + "cwspke_pulp_separated_from_waste_water";
      }),
      relationship("Observation__r", "Submission_ID__c", dataValue("id")),
      field("RecordTypeId", "01224000000oSG8AAM"),
      relationship("Observation_Criterion__r", "Unique_Name__c", "cwspke_pulp_separated_from_waste_water"),
...
each(
  ...
  upsertIf(
    ...
    fields(
      field("Submission_ID__c", function(state){
        return dataValue("id")(state) + "cwspke_pulp_being_properly_managed";
      }),
      relationship("Observation__r", "Submission_ID__c", dataValue("id")),
      field("RecordTypeId", "01224000000oSG8AAM"),
      relationship("Observation_Criterion__r", "Unique_Name__c", "cwspke_pulp_being_properly_managed"),
      field("Result__c", function(state){
...
each(
  ...
  upsertIf(
    ...
    fields(
      field("Submission_ID__c", function(state){
        return dataValue("id")(state) + "cwspke_pulp_30_meters_from_water";
      }),
      relationship("Observation__r", "Submission_ID__c", dataValue("id")),
      field("RecordTypeId", "01224000000oSG8AAM"),
      relationship("Observation_Criterion__r", "Unique_Name__c", "cwspke_pulp_30_meters_from_water"),
      field("Result__c", function(state){
...
each(
  ...
  upsertIf(
    ...
    fields(
      field("Submission_ID__c", function(state){
        return dataValue("id")(state) + "cwspke_pulp_protected_by_grass";
      }),
      relationship("Observation__r", "Submission_ID__c", dataValue("id")),
      field("RecordTypeId", "01224000000oSG8AAM"),
      relationship("Observation_Criterion__r", "Unique_Name__c", "cwspke_pulp_protected_by_grass"),
      field("Result__c", function(state){
...
each(
  ...
  upsertIf(
    ...
    fields(
      field("Submission_ID__c", function(state){
        return dataValue("id")(state) + "cwspke_disposed_last_season_husks";
      }),
      relationship("Observation__r", "Submission_ID__c", dataValue("id")),
      field("RecordTypeId", "01224000000oSG7AAM"),
      relationship("Observation_Criterion__r", "Unique_Name__c", "cwspke_disposed_last_season_husks"),
      field("Result__c", function(state){
...
each(
  ...
  upsertIf(
    ...
    fields(
      field("Submission_ID__c", function(state){
        return dataValue("id")(state) + "cwspke_plan_to_dispose_this_season_husks";
      }),
      relationship("Observation__r", "Submission_ID__c", dataValue("id")),
      field("RecordTypeId", "01224000000oSG7AAM"),
      relationship("Observation_Criterion__r", "Unique_Name__c", "cwspke_plan_to_dispose_this_season_husks"),
      field("Result__c", function(state){
...
each(
  ...
  upsertIf(
    ...
    fields(
      field("Submission_ID__c", function(state){
        return dataValue("id")(state) + "cwspke_plans_of_disposing_coffee_husks";
      }),
      relationship("Observation__r", "Submission_ID__c", dataValue("id")),
      field("RecordTypeId", "01224000000oSG7AAM"),
      relationship("Observation_Criterion__r", "Unique_Name__c", "cwspke_plans_of_disposing_coffee_husks"),
      field("Comments__c", function(state) {
        var disposal = '';
...
each(
  ...
  upsertIf(
    ...
    fields(
      field("Submission_ID__c", function(state){
        return dataValue("id")(state) + "cwspke_pulp_and_husk_picture";
      }),
      relationship("Observation__r", "Submission_ID__c", dataValue("id")),
      ...
      relationship("Observation_Criterion__r", "Unique_Name__c", "cwspke_pulp_and_husk_picture"),
      field("Photo_URL__c", function(state) {
...
each(
  ...
  upsertIf(
    ...
    fields(
      field("Submission_ID__c", function(state){
        return dataValue("id")(state) + "cwspke_collecting_samples_check";
      }),
      relationship("Observation__r", "Submission_ID__c", dataValue("id")),
      field("RecordTypeId", "0121o000001149CAAQ"),
      relationship("Observation_Criterion__r", "Unique_Name__c", "cwspke_collecting_samples_check"),
      field("Comments__c", function(state){
...
each(
  ...
  upsertIf(
    ...
    fields(
      field("Submission_ID__c", function(state){
        return dataValue("id")(state) + "cwspke_attend_general_meeting_check";
      }),
      relationship("Observation__r", "Submission_ID__c", dataValue("id")),
      field("RecordTypeId", "0121o000001149HAAQ"),
      relationship("Observation_Criterion__r", "Unique_Name__c", "cwspke_attend_general_meeting_check"),
      field("Comments__c", function(state){
...
each(
  ...
  upsertIf(
    ...
    fields(
      field("Submission_ID__c", function(state){
        return dataValue("id")(state) + "cwspke_attend_mill_review_check";
      }),
      relationship("Observation__r", "Submission_ID__c", dataValue("id")),
      field("RecordTypeId", "0121o000001149MAAQ"),
      relationship("Observation_Criterion__r", "Unique_Name__c", "cwspke_attend_mill_review_check"),
      field("Comments__c", function(state){
...
each(
  ...
  upsertIf(
    ...
    fields(
      field("Submission_ID__c", function(state){
        return dataValue("id")(state) + "cwspke_machine_audit_check";
      }),
      relationship("Observation__r", "Submission_ID__c", dataValue("id")),
      field("RecordTypeId", "0121o000001149RAAQ"),
      relationship("Observation_Criterion__r", "Unique_Name__c", "cwspke_machine_audit_check"),
      field("Comments__c", function(state){
...
each(
  ...
  upsertIf(
    ...
    fields(
      field("Submission_ID__c", function(state){
        return dataValue("id")(state) + "cwspke_coffee_quality_check";
      }),
      relationship("Observation__r", "Submission_ID__c", dataValue("id")),
      field("RecordTypeId", "0121o000001149WAAQ"),
      relationship("Observation_Criterion__r", "Unique_Name__c", "cwspke_coffee_quality_check"),
      field("Comments__c", function(state){
...
each(
  ...
  upsertIf(
    ...
    fields(
      field("Submission_ID__c", function(state){
        return dataValue("id")(state) + "cwspke_stakeholder_meeting_check";
      }),
      relationship("Observation__r", "Submission_ID__c", dataValue("id")),
      field("RecordTypeId", "0121o00000114HzAAI"),
      relationship("Observation_Criterion__r", "Unique_Name__c", "cwspke_stakeholder_meeting_check"),
      field("Comments__c", function(state){
...
each(
  ...
  upsertIf(
    ...
    fields(
      field("Submission_ID__c", function(state){
        return dataValue("id")(state) + "cwspke_water_consumption_check";
      }),
      relationship("Observation__r", "Submission_ID__c", dataValue("id")),
      field("RecordTypeId", "0121o00000114HpAAI"),
      relationship("Observation_Criterion__r", "Unique_Name__c", "cwspke_water_consumption_check"),
      field("Comments__c", function(state){
...
each(
  ...
  upsertIf(
    ...
    fields(
      field("Submission_ID__c", function(state){
        return dataValue("id")(state) + "cwspke_mill_have_a_recirculation_pump";
      }),
      relationship("Observation__r", "Submission_ID__c", dataValue("id")),
      field("RecordTypeId", "0121o00000114HpAAI"),
      relationship("Observation_Criterion__r", "Unique_Name__c", "cwspke_mill_have_a_recirculation_pump"),
      field("Result__c", function(state){
...
each(
  ...
  upsertIf(
    ...
    fields(
      field("Submission_ID__c", function(state){
        return dataValue("id")(state) + "cwspke_recirculation_pump_working";
      }),
      relationship("Observation__r", "Submission_ID__c", dataValue("id")),
      field("RecordTypeId", "0121o00000114HpAAI"),
      relationship("Observation_Criterion__r", "Unique_Name__c", "cwspke_recirculation_pump_working"),
      field("Result__c", function(state){
...
each(
  ...
  upsertIf(
    ...
    fields(
      field("Submission_ID__c", function(state){
        return dataValue("id")(state) + "cwspke_mill_have_a_water_meter";
      }),
      relationship("Observation__r", "Submission_ID__c", dataValue("id")),
      field("RecordTypeId", "0121o00000114HpAAI"),
      relationship("Observation_Criterion__r", "Unique_Name__c", "cwspke_mill_have_a_water_meter"),
      field("Result__c", function(state){
...
each(
  ...
  upsertIf(
    ...
    fields(
      field("Submission_ID__c", function(state){
        return dataValue("id")(state) + "cwspke_water_meter_working";
      }),
      relationship("Observation__r", "Submission_ID__c", dataValue("id")),
      field("RecordTypeId", "0121o00000114HpAAI"),
      relationship("Observation_Criterion__r", "Unique_Name__c", "cwspke_water_meter_working"),
      field("Result__c", function(state){
...
each(
  ...
  upsertIf(
    ...
    fields(
      field("Submission_ID__c", function(state){
        return dataValue("id")(state) + "cwspke_risk_assessment_check";
      }),
      relationship("Observation__r", "Submission_ID__c", dataValue("id")),
      field("RecordTypeId", "0121o00000114I4AAI"),
      relationship("Observation_Criterion__r", "Unique_Name__c", "cwspke_risk_assessment_check"),
      field("Comments__c", function(state){
...
each(
  ...
  upsertIf(
    ...
    fields(
      field("Submission_ID__c", function(state){
        return dataValue("id")(state) + "cwspke_environmental_audit_check";
      }),
      relationship("Observation__r", "Submission_ID__c", dataValue("id")),
      field("RecordTypeId", "0121o00000114I9AAI"),
      relationship("Observation_Criterion__r", "Unique_Name__c", "cwspke_environmental_audit_check"),
      field("Comments__c", function(state){
...
each(
  ...
  upsertIf(
    ...
    fields(
      field("Submission_ID__c", function(state){
        return dataValue("id")(state) + "cwspke_other_activity_check";
      }),
      relationship("Observation__r", "Submission_ID__c", dataValue("id")),
      field("RecordTypeId", "0121o000001149bAAA"),
      relationship("Observation_Criterion__r", "Unique_Name__c", "cwspke_other_activity_check"),
      field("Comments__c", function(state){
