...
each(
  ...
  upsert("Observation_Result__c", "Submission_ID__c",
    ...
    field("Submission_ID__c", function(state) {
      return dataValue("id")(state) + "coffeerw_prepare_and_implement_agronomy_practice-p1";
    }),
    ...
    relationship("Observation_Criterion__r", "Unique_Name__c", "coffeerw_prepare_and_implement_agronomy_practice"),
...
each(
  ...
  upsert("Observation_Result__c",  "Submission_ID__c",
    fields(
    field("Submission_ID__c", function(state) {
      return dataValue("id")(state) + "coffeerw_prepare_and_implement_agronomy_practice-p2";
    }),
    relationship("Observation__r", "Submission_ID__c", dataValue("id")),/*function(state){
      return state.references[state.references.length-1].id;
    }),*/
...
each(
  ...
  upsert("Observation_Result__c",  "Submission_ID__c",
    fields(
    field("Submission_ID__c", function(state) {
      return dataValue("id")(state) + "coffeerw_prepare_and_implement_agronomy_practice-p3";
    }),
    relationship("Observation__r", "Submission_ID__c", dataValue("id")),/*function(state){
      return state.references[state.references.length-1].id;
    }),*/
...
each(
  ...
  upsert("Observation_Result__c",  "Submission_ID__c",
    fields(
    field("Submission_ID__c", function(state) {
      return dataValue("id")(state) + "coffeerw_teaching_clarity_and_effectiveness-p1";
    }),
    relationship("Observation__r", "Submission_ID__c", dataValue("id")),/*function(state){
      return state.references[state.references.length-1].id;
    }),*/
    field("RecordTypeId", "01224000000gQe6AAE"),
    relationship("Observation_Criterion__r", "Unique_Name__c", "coffeerw_teaching_clarity_and_effectiveness"),
    field("Participant_Sex__c", dataValue("form.Participant_One_Feedback.Participant_Gender")),
...
each(
  ...
  upsert("Observation_Result__c",  "Submission_ID__c",
    fields(
    field("Submission_ID__c", function(state) {
      return dataValue("id")(state) + "coffeerw_teaching_clarity_and_effectiveness-p2";
    }),
    relationship("Observation__r", "Submission_ID__c", dataValue("id")),/*function(state){
      return state.references[state.references.length-1].id;
    }),*/
...
each(
  ...
  upsert("Observation_Result__c",  "Submission_ID__c",
    fields(
    field("Submission_ID__c", function(state) {
      return dataValue("id")(state) + "coffeerw_teaching_clarity_and_effectiveness-p3";
    }),
    relationship("Observation__r", "Submission_ID__c", dataValue("id")),/*function(state){
      return state.references[state.references.length-1].id;
    }),*/
...
each(
  ...
  upsert("Observation_Result__c",  "Submission_ID__c",
    fields(
    field("Submission_ID__c", function(state) {
      return dataValue("id")(state) + "coffeerw_knowledge_of_trainer_on_agronomy-p1";
    }),
    relationship("Observation__r", "Submission_ID__c", dataValue("id")),/*function(state){
      return state.references[state.references.length-1].id;
    }),*/
    field("RecordTypeId", "01224000000gQe6AAE"),
    relationship("Observation_Criterion__r", "Unique_Name__c", "coffeerw_knowledge_of_trainer_on_agronomy"),
    field("Participant_Sex__c", dataValue("form.Participant_One_Feedback.Participant_Gender")),
...
each(
  ...
  upsert("Observation_Result__c",  "Submission_ID__c",
    fields(
    field("Submission_ID__c", function(state) {
      return dataValue("id")(state) + "coffeerw_knowledge_of_trainer_on_agronomy-p2";
    }),
    relationship("Observation__r", "Submission_ID__c", dataValue("id")),/*function(state){
      return state.references[state.references.length-1].id;
    }),*/
...
each(
  ...
  upsert("Observation_Result__c",  "Submission_ID__c",
    fields(
    field("Submission_ID__c", function(state) {
      return dataValue("id")(state) + "coffeerw_knowledge_of_trainer_on_agronomy-p3";
    }),
    relationship("Observation__r", "Submission_ID__c", dataValue("id")),/*function(state){
      return state.references[state.references.length-1].id;
    }),*/
...
each(
  ...
  upsert("Observation_Result__c",  "Submission_ID__c",
    fields(
    field("Submission_ID__c", function(state) {
      return dataValue("id")(state) + "coffeerw_shows_professionalism";
    }),
    relationship("Observation__r", "Submission_ID__c", dataValue("id")),/*function(state){
      return state.references[state.references.length-1].id;
    }),*/
    field("RecordTypeId", "01224000000gQe7AAE"),
    relationship("Observation_Criterion__r", "Unique_Name__c", "coffeerw_shows_professionalism"),
...
each(
  ...
  upsert("Observation_Result__c",  "Submission_ID__c",
    fields(
    field("Submission_ID__c", function(state) {
      return dataValue("id")(state) + "coffeerw_is_prepared_and_organized";
    }),
    relationship("Observation__r", "Submission_ID__c", dataValue("id")),/*function(state){
      return state.references[state.references.length-1].id;
    }),*/
    field("RecordTypeId", "01224000000gQe7AAE"),
    relationship("Observation_Criterion__r", "Unique_Name__c", "coffeerw_is_prepared_and_organized"),
...
each(
  ...
  upsert("Observation_Result__c",  "Submission_ID__c",
    fields(
    field("Submission_ID__c", function(state) {
      return dataValue("id")(state) + "coffeerw_engages_participants";
    }),
    relationship("Observation__r", "Submission_ID__c", dataValue("id")),/*function(state){
      return state.references[state.references.length-1].id;
    }),*/
    field("RecordTypeId", "01224000000gQe7AAE"),
    relationship("Observation_Criterion__r", "Unique_Name__c", "coffeerw_engages_participants"),
...
each(
  ...
  upsert("Observation_Result__c",  "Submission_ID__c",
    fields(
    field("Submission_ID__c", function(state) {
      return dataValue("id")(state) + "coffeerw_facilitates_openings_and_closings";
    }),
    relationship("Observation__r", "Submission_ID__c", dataValue("id")),/*function(state){
      return state.references[state.references.length-1].id;
    }),*/
    field("RecordTypeId", "01224000000gQe7AAE"),
    relationship("Observation_Criterion__r", "Unique_Name__c", "coffeerw_facilitates_openings_and_closings"),
...
each(
  ...
  upsert("Observation_Result__c",  "Submission_ID__c",
    fields(
    field("Submission_ID__c", function(state) {
      return dataValue("id")(state) + "coffeerw_leads_activities";
    }),
    relationship("Observation__r", "Submission_ID__c", dataValue("id")),/*function(state){
      return state.references[state.references.length-1].id;
    }),*/
    field("RecordTypeId", "01224000000gQe7AAE"),
    relationship("Observation_Criterion__r", "Unique_Name__c", "coffeerw_leads_activities"),
...
each(
  ...
  upsert("Observation_Result__c",  "Submission_ID__c",
    fields(
    field("Submission_ID__c", function(state) {
      return dataValue("id")(state) + "coffeerw_leads_discussions";
    }),
    relationship("Observation__r", "Submission_ID__c", dataValue("id")),/*function(state){
      return state.references[state.references.length-1].id;
    }),*/
    field("RecordTypeId", "01224000000gQe7AAE"),
    relationship("Observation_Criterion__r", "Unique_Name__c", "coffeerw_leads_discussions"),
...
each(
  ...
  upsert("Observation_Result__c",  "Submission_ID__c",
    fields(
    field("Submission_ID__c", function(state) {
      return dataValue("id")(state) + "coffeerw_follows_lesson_plans";
    }),
    relationship("Observation__r", "Submission_ID__c", dataValue("id")),/*function(state){
      return state.references[state.references.length-1].id;
    }),*/
    field("RecordTypeId", "01224000000gQe7AAE"),
    relationship("Observation_Criterion__r", "Unique_Name__c", "coffeerw_follows_lesson_plans"),
...
each(
  ...
  upsert("Observation_Result__c",  "Submission_ID__c",
    fields(
    field("Submission_ID__c", function(state) {
      return dataValue("id")(state) + "coffeerw_manages_time";
    }),
    relationship("Observation__r", "Submission_ID__c", dataValue("id")),/*function(state){
      return state.references[state.references.length-1].id;
    }),*/
    field("RecordTypeId", "01224000000gQe7AAE"),
    relationship("Observation_Criterion__r", "Unique_Name__c", "coffeerw_manages_time"),
...
/* OLD TRAINING OBSERVATION JOB
each(
  "$.data",
	create("Observation__c",
		fields(
			field("Observer__c", dataValue("form.Observer")),
			field("Trainer__c", dataValue("form.Who_Are_You_Observing")),
			field("Training_Group__c", dataValue("form.Which_Group_Is_Farmer_Trainer_Teaching")),
			field("Training_Session__c", dataValue("form.selected_session")),
			field("RecordTypeId", dataValue("form.Record_Type")),
			field("Date__c", dataValue("form.Date")),
			...
			field("Participant_Gender_1__c", dataValue("form.Participant_One_Feedback.Participant_Gender")),
			field("Prepare_Implement_Agronomy_Practice_1__c", dataValue("form.Participant_One_Feedback.Prepare_And_Implement_Agronomy_Practice")),
			field("Teaching_Clarity_and_Effectiveness_1__c", dataValue("form.Participant_One_Feedback.Teaching_Clarity_And_Effectiveness")),
			field("Knowledge_of_Trainer_on_Agronomy_1__c", dataValue("form.Participant_One_Feedback.Knowledge_Of_Trainer_On_Agronomy")),
			field("Comments_1__c", dataValue("form.Participant_One_Feedback.participant_comments")),

			field("Participant_Gender_2__c", dataValue("form.Participant_Two_Feedback.Participant_Gender")),
			field("Prepare_Implement_Agronomy_Practice_2__c", dataValue("form.Participant_Two_Feedback.Prepare_And_Implement_Agronomy_Practice")),
			field("Teaching_Clarity_and_Effectiveness_2__c", dataValue("form.Participant_Two_Feedback.Teaching_Clarity_And_Effectiveness")),
			field("Knowledge_of_Trainer_on_Agronomy_2__c", dataValue("form.Participant_Two_Feedback.Knowledge_Of_Trainer_On_Agronomy")),
			field("Comments_2__c", dataValue("form.Participant_Two_Feedback.participant_comments")),

			field("Participant_Gender_3__c", dataValue("form.Participant_Three_Feedback.Participant_Gender")),
			field("Prepare_Implement_Agronomy_Practice_3__c", dataValue("form.Participant_Three_Feedback.Prepare_And_Implement_Agronomy_Practice")),
			field("Teaching_Clarity_and_Effectiveness_3__c", dataValue("form.Participant_Three_Feedback.Teaching_Clarity_And_Effectiveness")),
			field("Knowledge_of_Trainer_on_Agronomy_3__c", dataValue("form.Participant_Three_Feedback.Knowledge_Of_Trainer_On_Agronomy")),
			field("Comments_3__c", dataValue("form.Participant_Three_Feedback.participant_comments")),
...
each(
  "$.data",
	create("Observation_Result__c", fields(
